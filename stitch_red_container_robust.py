...
# Đây là phiên bản "robust" để ghép container màu đỏ.
# Nó sử dụng lại kiến trúc ghép nối tiếp đã thành công với container vàng,
# dựa trên việc dò đặc điểm (SIFT/ORB) và có cơ chế fallback,
# đồng thời được tùy chỉnh để nhận diện container màu đỏ.
...
def main():
    ...
    base = Path(r"D:\Documents\Container Snitching\mnt\2025-09-04_15-25-13")
