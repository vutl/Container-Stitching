...
def main():
    ...
    ap.add_argument('--corners2-dir', required=True, help='Corners directory for segment 2 (e.g., out_annot_2_full)')
    ap.add_argument('--out1', default='out_trimmed_sides_1', help='Output directory for trimmed images of segment 1')
    ap.add_argument('--out2', default='out_trimmed_sides_2', help='Output directory for trimmed images of segment 2')
    ap.add_argument('--corners1-out', default='out_trimmed_sides_corners_1', help='Output directory for updated corners of segment 1')
    ap.add_argument('--corners2-out', default='out_trimmed_sides_corners_2', help='Output directory for updated corners of segment 2')
    ...
    corners2_dir = Path(args.corners2_dir)
    ...
    c2o = Path(args.corners2_out); c2o.mkdir(parents=True, exist_ok=True)
